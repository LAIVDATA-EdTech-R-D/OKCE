...
parser.add_argument('--data_path', required=True, help='input data file')
parser.add_argument('--n_epochs', default=100, help='# of train epochs')
...
train(model, n_epochs,train_loader,device,optimizer,valid_loader,n_items,auc_history,f1_score_history)
